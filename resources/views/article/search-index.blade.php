<x-layout title="Articoli cercati">
    @if (count($articles)!=0)
        ...
        <div class="row">
            <div class="col-12 mt-5">
                <h2 class="text-center display-5 my-5">Risultati per la ricerca: {{$query}}</h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="filter-container">
                            ...
                            <div class="container-list-cst">
                                <div class="cont-inner-cst">
                                    <ul class="list-cst">
                                        <li><a href="{{route('article.searchByNewest', $query)}}" id="ArtByNewest" class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Articoli più recenti</a></li>
                                        <li><a href="{{route('article.searchByOldest', $query)}}" id="ArtByOldest" class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Articoli più vecchi</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>                    
    ...
    <div class="container my-5 min-vh-100">
        <div class="row">
            <div class="col-12 mt-5">
                <h2 class="text-center display-5 my-5">Non sono stati trovati articoli per questa ricerca: {{$query}}</h2>
            </div>
        </div>
    </div>
    @endif
