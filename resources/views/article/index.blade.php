    ...
    <div class="container my-5 min-vh-100">
        <div class="row">
            <div class="col-12 mt-5">
                <h2 class="text-center display-5 my-5">Controlla i nostri articoli!</h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="filter-container">
                            ...
                            <div class="container-list-cst">
                                <div class="cont-inner-cst">
                                    <ul class="list-cst">
                                        <li><a href="{{route('article.byNewest')}}" id="ArtByNewest" class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Articoli più recenti</a></li>
                                        <li><a href="{{route('article.byOldest')}}" id="ArtByOldest" class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Articoli più vecchi</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>                    
            ...
            <div class="col-12 col-md-6 my-3">
                <article class="card p-3 crd-cst articleWrapper article-loading" data-bs-theme="dark">
                    ...
                    <div data-artP="articlePreviewWrapper" class="d-flex justify-content-center my-3">
                        <div class="d-flex flex-column align-items-center justify-content-center cst-art c-me pb-1">
                            @if ($article->category)
                            <div>
